 ...
 * on 2019/12/8 0008
 */
@Route(path = "/main/PrepareListDetialActivity")
public class PrepareListDetialActivity extends BaseActivity {
    ...
    public static void start() {
        ARouter.getInstance().build(ARouterPath.getPrepareListDetialActivity()).navigation();
    }
...
//        requestData();
    ...
    private void requestData() {
        OkHttpUtils.post()
                .url(Api.GET_PREPARE_LIST_DETIAL)
                .addParams("orderId", "")
                .tag(this)
                .build()
                .execute(new StringCallback() {
                    ...
                    public void onResponse(String response, int id) {
                        PrepareListDetialResponse resp = JsonUtils.parseByGson(response, PrepareListDetialResponse.class);
                        if (resp != null) {
...
//                helper.setText(R.id.tvNum,"");
    ...
    protected int getLayoutId() {
        return R.layout.activity_prepare_list_detail_layout;
    }
}
