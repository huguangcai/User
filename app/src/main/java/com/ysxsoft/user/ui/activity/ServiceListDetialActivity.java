...
import com.ysxsoft.user.modle.PrepareListDetialResponse;
 ...
 * on 2019/12/8 0008
 */
@Route(path = "/main/ServiceListDetialActivity")
public class ServiceListDetialActivity extends BaseActivity {
    ...
    public static void start() {
        ARouter.getInstance().build(ARouterPath.getServiceListDetialActivity()).navigation();
    }
...
//        requestData();
    ...
    private void requestData() {
        OkHttpUtils.post()
                .url(Api.GET_SERVICE_LIST_DETIAL)
                .addParams("orderId", "")
                .tag(this)
                .build()
                .execute(new StringCallback() {
                    ...
                    public void onResponse(String response, int id) {
                        ServiceListDetialResponse resp = JsonUtils.parseByGson(response, ServiceListDetialResponse.class);
                        if (resp != null) {
...
//                Glide.with(mContext).load("").into(riv);
    ...
    protected int getLayoutId() {
        return R.layout.activity_service_list_detail_layout;
    }
}
