 ...
 * on 2019/12/14 0014
 */
@Route(path = "/main/WaittingCarCheckArriveActivity")
public class WaittingCarCheckArriveActivity extends BaseActivity {
    ...
    public static void start(String orderId){
        ARouter.getInstance().build(ARouterPath.getWaittingCarCheckArriveActivity()).withString("orderId",orderId).navigation();
    }

    @Override
    protected int getLayoutId() {
        return R.layout.waitting_car_check_arrive_layout;
    }
