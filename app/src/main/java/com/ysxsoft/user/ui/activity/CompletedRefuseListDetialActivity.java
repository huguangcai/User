...
import com.ysxsoft.user.modle.CompletedRefuseListDetialResponse;
 ...
 * on 2019/12/8 0008
 */
@Route(path = "/main/CompletedRefuseListDetialActivity")
public class CompletedRefuseListDetialActivity extends BaseActivity {
    ...
    @BindView(R.id.tvRefuseCause)
    TextView tvRefuseCause;
    @BindView(R.id.tvRefuseMark)
    TextView tvRefuseMark;
    @BindView(R.id.llshow)
    LinearLayout llshow;
    private BaseQuickAdapter<String, BaseViewHolder> adapter;

    public static void start() {
        ARouter.getInstance().build(ARouterPath.getCompletedRefuseListDetialActivity()).navigation();
    }
...
//        requestData();
    ...
    private void requestData() {
        OkHttpUtils.post()
                .url(Api.GET_COMPLETE_REFUSE_LIST_DETIAL)
                .addParams("orderId", "")
                .tag(this)
                .build()
                .execute(new StringCallback() {
                    ...
                    public void onResponse(String response, int id) {
                        CompletedRefuseListDetialResponse resp = JsonUtils.parseByGson(response, CompletedRefuseListDetialResponse.class);
                        if (resp != null) {
...
//                helper.setText(R.id.tvNum,"");
    ...
    protected int getLayoutId() {
        return R.layout.activity_complete_refuse_list_detail_layout;
    }
}
