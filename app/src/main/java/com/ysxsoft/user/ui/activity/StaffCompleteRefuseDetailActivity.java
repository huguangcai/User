 ...
 * on 2019/12/14 0014
 */
@Route(path = "/main/StaffCompleteRefuseDetailActivity")
public class StaffCompleteRefuseDetailActivity extends BaseActivity {
    ...
    public static void start(){
        ARouter.getInstance().build(ARouterPath.getStaffCompleteRefuseDetailActivity()).navigation();
    }

    @Override
    protected int getLayoutId() {
        return R.layout.activity_staff_complete_refuse_detail_layout;
    }
    ...
    private void requestData() {
        OkHttpUtils.get()
                .url(Api.GET_STAFF_COMPLETED_REFUSE_DETAIL)
