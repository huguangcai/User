 ...
 * on 2019/12/14 0014
 */
@Route(path = "/main/SongCarWaitCheckDetialActivity")
public class SongCarWaitCheckDetialActivity extends BaseActivity {
    ...
    protected int getLayoutId() {
        return R.layout.songing_car_wait_check_detail_layout;
    }
