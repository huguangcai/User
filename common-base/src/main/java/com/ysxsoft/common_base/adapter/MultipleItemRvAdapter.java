...
import com.ysxsoft.common_base.adapter.provider.BaseItemProvider;
import com.ysxsoft.common_base.adapter.util.MultiTypeDelegate;
import com.ysxsoft.common_base.adapter.util.ProviderDelegate;
 ...
 * @author ChayChan
 * @description:
 * When there are multiple entries, avoid too much business logic in convert(),Put the logic of each item_evaluate_list_layout in the corresponding ItemProvider
