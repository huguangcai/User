package com.ysxsoft.common_base.adapter.provider;
...
public abstract class BaseItemProvider<T,V extends BaseViewHolder> {
    ...
    //子类若想实现条目点击事件则重写该方法
    //Subclasses override this method if you want to implement an item_evaluate_list_layout click event
    public void onClick(V helper, T data, int position){};

    //子类若想实现条目长按事件则重写该方法
    //Subclasses override this method if you want to implement an item_evaluate_list_layout long press event
