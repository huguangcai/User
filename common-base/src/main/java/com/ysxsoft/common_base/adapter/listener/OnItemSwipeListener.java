...
public interface OnItemSwipeListener {
     ...
     * If you change the view on the start, you should reset is here, no matter the item_evaluate_list_layout has swiped or not.
     *
    ...
    /**
     * Called when item_evaluate_list_layout is swiped, the view is going to be removed from the adapter.
     */
