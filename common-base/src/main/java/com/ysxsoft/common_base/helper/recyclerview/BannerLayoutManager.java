...
public  class BannerLayoutManager extends RecyclerView.LayoutManager {
   ...
   private float  moveSpeed=1.0f;
    ...
    //用法
//    BannerLayoutManager mLayoutManager = new BannerLayoutManager(getActivity(), BannerLayoutManager.HORIZONTAL);
//        mLayoutManager.setItemSpace(DisplayUtils.dip2px(getActivity(), 40));
//        mLayoutManager.setCenterScale(1.4f);
//        mLayoutManager.setMoveSpeed(1.4f);
