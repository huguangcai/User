...
public class VideoSelectPicker extends Dialog implements View.OnClickListener {
    ...
    public VideoSelectPicker(@NonNull Context context, int themeResId) {
    ...
    private View init() {
        View view = View.inflate(mContext, R.layout.dialog_video_select_picker, null);
        ...
        picker1.setOnScrollListener(new NumberPickerView.OnScrollListener() {
            @Override
            public void onScrollStateChange(NumberPickerView view, int scrollState) {
//                picker2.setDisplayedValuesAndPickedIndex(dataArray2, picker1.getValue(), true);
                picker2.setDisplayedValuesAndPickedIndex(dataArray2,0, true);
            }
        });
        return view;
    }
