...
import com.ysxsoft.common_base.view.custom.image.group.cache.DiskLruCacheHelper;
import com.ysxsoft.common_base.view.custom.image.group.cache.LruCacheHelper;
...
public class BitmapLoader {
    ...
    private Bitmap loadBitmap(String url, int reqWidth, int reqHeight) {
        ...
        if (bitmap != null) {
//            LogUtil.e(TAG, "load from memory:" + url);
            return bitmap;
        }
...
//                Log.e(TAG, "load from disk:" + url);
    ...
    private boolean collectUndoTasks(String url, Runnable task) {
        String key = Utils.hashKeyFormUrl(url);
        Log.e("tag","lruCacheHelper:"+mDiskLruCache);
        ...
        try {
            Log.e("tag","mDiskLruCache:"+mDiskLruCache);
