...
import com.ysxsoft.common_base.view.custom.image.group.listener.OnHandlerListener;
...
public class CombineHelper {
    ...
    private void loadByUrls(final Builder builder) {
        ...
        LogUtils.e("tag","加载图片:builder.count"+builder.count+"urls:"+new Gson().toJson(builder.urls));
