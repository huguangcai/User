...
public class ERatingBar extends LinearLayout {
    ...
    public ERatingBar(Context context, AttributeSet attrs) {
        super(context, attrs);
        setOrientation(LinearLayout.HORIZONTAL);
        TypedArray mTypedArray = context.obtainStyledAttributes(attrs, R.styleable.ERatingBar);

        starHalfDrawable = mTypedArray.getDrawable(R.styleable.ERatingBar_starHalf);
        starEmptyDrawable = mTypedArray.getDrawable(R.styleable.ERatingBar_starEmpty);
        starFillDrawable = mTypedArray.getDrawable(R.styleable.ERatingBar_starFill);
        starImageSize = mTypedArray.getDimension(R.styleable.ERatingBar_starImageSize, 120);
        starImageWidth = mTypedArray.getDimension(R.styleable.ERatingBar_starImageWidth, 60);
        starImageHeight = mTypedArray.getDimension(R.styleable.ERatingBar_starImageHeight, 120);
        starImagePadding = mTypedArray.getDimension(R.styleable.ERatingBar_starImagePadding, 0);
        starCount = mTypedArray.getInteger(R.styleable.ERatingBar_starCount, 5);
        starNum = mTypedArray.getInteger(R.styleable.ERatingBar_starNum, 0);
        mClickable = mTypedArray.getBoolean(R.styleable.ERatingBar_clickable, true);
        halfstart = mTypedArray.getBoolean(R.styleable.ERatingBar_halfstart, false);
